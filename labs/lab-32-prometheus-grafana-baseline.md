# Lab 32 — Prometheus & Grafana

Ce lab fait partie du parcours Kubernetes The Hard Way Architect Edition.

## Objectif
Mettre en pratique les concepts de la version V33 : Prometheus & Grafana.
...
### Étape 3 : Validation
Exécutez le script de validation associé (`scripts/40-validate-*.sh`).

### Étape 4 : Exploration
Explorez les fonctionnalités déployées et notez vos observations.

## Résultat attendu
La couche Prometheus & Grafana est opérationnelle et validée.
