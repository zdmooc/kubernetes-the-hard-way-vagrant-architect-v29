# Lab 33 — Loki & Promtail

Ce lab fait partie du parcours Kubernetes The Hard Way Architect Edition.

## Objectif
Mettre en pratique les concepts de la version V34 : Loki & Promtail.
...
### Étape 3 : Validation
Exécutez le script de validation associé (`scripts/41-validate-*.sh`).

### Étape 4 : Exploration
Explorez les fonctionnalités déployées et notez vos observations.

## Résultat attendu
La couche Loki & Promtail est opérationnelle et validée.
