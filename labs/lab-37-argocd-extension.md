# Lab 37 — ArgoCD Extension

Ce lab fait partie du parcours Kubernetes The Hard Way Architect Edition.

## Objectif
Mettre en pratique les concepts de la version V38 : ArgoCD Extension.
...
### Étape 3 : Validation
Exécutez le script de validation associé (`scripts/45-validate-*.sh`).

### Étape 4 : Exploration
Explorez les fonctionnalités déployées et notez vos observations.

## Résultat attendu
La couche ArgoCD Extension est opérationnelle et validée.
